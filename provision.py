...
POSIX file I/O so there is nothing to install before the proof of concept runs.
    ...
    ./tools/provision.py ports
    ./tools/provision.py status
    ./tools/provision.py gen-secrets     # bake keys into the firmware image
    ./tools/provision.py provision       # or store them over the console
    ./tools/provision.py pair
    ./tools/provision.py monitor
"""
...
def command_gen_secrets(args: argparse.Namespace) -> None:
    ...
    header = [
        "// Generated by tools/provision.py gen-secrets. Do not commit.",
        "//",
    ...
    say("  cd firmware/simple && idf.py build && idf.py -p <port> flash")
    say("")
    say("Then pair it:  ./tools/provision.py pair")
...
def command_provision(args: argparse.Namespace) -> None:
    ...
    say("  ./tools/provision.py pair              # link it to your account")
...
def main() -> int:
    ...
    secrets = subparsers.add_parser(
        "gen-secrets", help="generate keys and write firmware/simple/main/secrets.h")
